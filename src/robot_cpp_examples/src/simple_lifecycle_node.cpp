...
public:
    ...
    rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_configure(const rclcpp_lifecycle::State &)
    {
        ...
        RCLCPP_INFO(get_logger(), "Lifecycle Node on-configure() called");
    ...
    {
        sub_.reset(); 
        RCLCPP_INFO(get_logger(), "Lifecycle Node on-shutdown() called");
        return rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::SUCCESS;
    }
    ...
    {
        sub_.reset(); 
        RCLCPP_INFO(get_logger(), "Lifecycle Node on-cleanup() called");
        return rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::SUCCESS;
    }
    ...
    rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_activate(const rclcpp_lifecycle::State & state)
    {
        ...
        RCLCPP_INFO(get_logger(), "Lifecycle Node on-activate() called");
    ...
    rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_deactivate(const rclcpp_lifecycle::State & state)
    {
        ...
        RCLCPP_INFO(get_logger(), "Lifecycle Node on-deactivate() called");
        std::this_thread::sleep_for(2s);
        return rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::SUCCESS;
    }
