...
class SimepleQoSSubscriber: public rclcpp::Node
{
    public:
    SimepleQoSSubscriber():Node("simple_qos_subscriber"), qos_profile_sub_(10)
    {
        ...
        ("topic", qos_profile_sub_, std::bind(&SimepleQoSSubscriber::topic_callback, this, _1));
    }
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<SimepleQoSSubscriber>());
  rclcpp::shutdown();
  return (0);
}